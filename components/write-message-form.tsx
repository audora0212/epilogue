...
export default function WriteMessageForm({ onBack }: WriteMessageFormProps) {
  ...
  return (
    <div className="relative h-[89vh] bg-white overflow-auto">
      ...
      <BottomBar>
        <Button
          ...
          size="xl"
          className="w-full bg-[#396F4B] bottom-20 text-white rounded-full font-medium font-pretendard disabled:bg-[#396F4B]/30 text-[16px]"
        >
